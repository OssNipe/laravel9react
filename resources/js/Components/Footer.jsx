...
const Footer = () => {
  return (
    ...
    <div className='max-w-[1240px] mx-auto py-16 px-4 grid bg-black lg:grid-cols-3 gap-8 text-gray-300'>
      <div>
        <h1 className='w-full text-3xl font-bold text-white'>SWAY3.</h1>
